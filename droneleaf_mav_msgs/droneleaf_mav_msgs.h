...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH -4412256276045209083
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_MANAGER_STATE
#define HAVE_ENUM_LEAF_MISSION_MANAGER_STATE
typedef enum LEAF_MISSION_MANAGER_STATE
{
   LEAF_MISSION_MANAGER_STATE_IDLE=0, /* Queue is empty, no mission loaded | */
   LEAF_MISSION_MANAGER_STATE_READY=1, /* Current mission is ready to execute | */
   LEAF_MISSION_MANAGER_STATE_RUNNING=2, /* Current mission is running | */
   LEAF_MISSION_MANAGER_STATE_SCHEDULED_PAUSE=3, /* Current mission is running but has a scheduled pause | */
   LEAF_MISSION_MANAGER_STATE_PAUSED_MID_STEP=4, /* Current mission is paused mid-step | */
   LEAF_MISSION_MANAGER_STATE_PAUSED_BETWEEN_STEPS=5, /* Current mission is paused between steps | */
   LEAF_MISSION_MANAGER_STATE_COMPLETED=6, /* Current mission completed successfully | */
   LEAF_MISSION_MANAGER_STATE_FAILED=7, /* Current mission failed | */
   LEAF_MISSION_MANAGER_STATE_CANCELLED=8, /* Current mission was cancelled | */
   LEAF_MISSION_MANAGER_STATE_SAFETY=9, /* Critical safety state, FC decides what to do | */
...
#include "./mavlink_msg_leaf_mission_manager_status.h"
...
#include "./mavlink_msg_leaf_mission_manager_heartbeat.h"

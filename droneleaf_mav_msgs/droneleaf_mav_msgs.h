...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH -325796327707987656
...
{
   LEAF_MISSION_STATUS_IDLE=0, /* Leaf mission manager is idle | */
   LEAF_MISSION_STATUS_READY=1, /* Leaf mission manager is idle | */
   LEAF_MISSION_STATUS_EXECUTING=2, /* Leaf mission manager is executing a mission | */
   LEAF_MISSION_STATUS_PAUSED=3, /* Leaf mission manager has paused the mission | */
...
typedef enum LEAF_CONTROL_COMMAND
{
   ...
   LEAF_CONTROL_CANCEL=2, /* Cancel the exection of the current mission | */
   LEAF_CONTROL_ABORT=3, /* Abort the exection of the current mission | */
   LEAF_CONTROL_COMMAND_ENUM_END=4, /*  | */
} LEAF_CONTROL_COMMAND;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_CONTROL_COMMAND_ACTION
#define HAVE_ENUM_LEAF_CONTROL_COMMAND_ACTION
typedef enum LEAF_CONTROL_COMMAND_ACTION
{
   LEAF_CONTROL_COMMAND_ACTION_NONE=0, /* None | */

...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH -8658698998805662256
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_INSPECTION_OPTION
#define HAVE_ENUM_LEAF_INSPECTION_OPTION
typedef enum LEAF_INSPECTION_OPTION
{
   LEAF_INSPECTION_OPTION_BOTH=0, /* Inspect both north and south | */
   LEAF_INSPECTION_OPTION_NORTH=1, /* Inspect only the north | */
   LEAF_INSPECTION_OPTION_SOUTH=2, /* Inspect only the south | */
   LEAF_INSPECTION_OPTION_ENUM_END=3, /*  | */
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_STATUS
#define HAVE_ENUM_LEAF_MISSION_STATUS
typedef enum LEAF_MISSION_STATUS
{
   LEAF_MISSION_STATUS_IDLE=0, /* Queue is empty, no mission loaded | */
   LEAF_MISSION_STATUS_READY=1, /* Current mission is ready to execute | */
   LEAF_MISSION_STATUS_RUNNING=2, /* Current mission is running | */
   LEAF_MISSION_STATUS_SCHEDULED_PAUSE=3, /* Current mission is running but has a scheduled pause | */
   LEAF_MISSION_STATUS_PAUSED_MID_STEP=4, /* Current mission is paused mid-step | */
   LEAF_MISSION_STATUS_PAUSED_BETWEEN_STEPS=5, /* Current mission is paused between steps | */
   LEAF_MISSION_STATUS_COMPLETED=6, /* Current mission completed successfully | */
   LEAF_MISSION_STATUS_FAILED=7, /* Current mission failed | */
   LEAF_MISSION_STATUS_CANCELLED=8, /* Current mission was cancelled | */
   LEAF_MISSION_STATUS_SAFETY=9, /* Critical safety state, FC decides what to do | */
   LEAF_MISSION_STATUS_ENUM_END=10, /*  | */
} LEAF_MISSION_STATUS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_CONTROL_COMMAND
#define HAVE_ENUM_LEAF_CONTROL_COMMAND
typedef enum LEAF_CONTROL_COMMAND
{
   LEAF_CONTROL_PAUSE=0, /* Pause the exection of the current mission | */
   LEAF_CONTROL_RESUME=1, /* Resume the exection of the current mission | */
   LEAF_CONTROL_ABORT=2, /* Abort the exection of the current mission | */
   LEAF_CONTROL_LAND_IN_PLACE=3, /* Land in place | */
   LEAF_CONTROL_RETURN_TO_LAUNCH=4, /* Return to launch | */
   LEAF_CONTROL_COMMAND_ENUM_END=5, /*  | */
...
#include "./mavlink_msg_leaf_do_inspect.h"
#include "./mavlink_msg_leaf_control_cmd.h"
...
#include "./mavlink_msg_leaf_inspection_option.h"
#include "./mavlink_msg_leaf_set_inspection_option.h"
...
#include "./mavlink_msg_leaf_do_mission_run.h"
#include "./mavlink_msg_leaf_ack_mission_run.h"
#include "./mavlink_msg_leaf_done_mission_run.h"
#include "./mavlink_msg_leaf_mission_status.h"
#include "./mavlink_msg_leaf_qgc_control_cmd.h"
#include "./mavlink_msg_leaf_qgc_mission_start.h"
#include "./mavlink_msg_leaf_qgc_rtl.h"
...
#include "./mavlink_msg_leaf_qgc_abort.h"

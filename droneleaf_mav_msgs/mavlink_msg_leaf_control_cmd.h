...
#define MAVLINK_MSG_ID_LEAF_CONTROL_CMD_LEN 66
#define MAVLINK_MSG_ID_LEAF_CONTROL_CMD_MIN_LEN 66
#define MAVLINK_MSG_ID_77015_LEN 66
#define MAVLINK_MSG_ID_77015_MIN_LEN 66

#define MAVLINK_MSG_ID_LEAF_CONTROL_CMD_CRC 227
#define MAVLINK_MSG_ID_77015_CRC 227
...
#define MAVLINK_MESSAGE_INFO_LEAF_CONTROL_CMD { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_leaf_control_cmd_t, target_system) }, \
         ...
         { "mission_id", NULL, MAVLINK_TYPE_CHAR, 64, 2, offsetof(mavlink_leaf_control_cmd_t, mission_id) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LEAF_CONTROL_CMD { \
...
{
    return mavlink_msg_leaf_control_cmd_pack(system_id, component_id, msg, leaf_control_cmd->target_system, leaf_control_cmd->cmd, leaf_control_cmd->mission_id);
}
...
{
    return mavlink_msg_leaf_control_cmd_pack_chan(system_id, component_id, chan, msg, leaf_control_cmd->target_system, leaf_control_cmd->cmd, leaf_control_cmd->mission_id);
}
...
{
    return mavlink_msg_leaf_control_cmd_pack_status(system_id, component_id, _status, msg,  leaf_control_cmd->target_system, leaf_control_cmd->cmd, leaf_control_cmd->mission_id);
}
...
static inline void mavlink_msg_leaf_control_cmd_send(mavlink_channel_t chan, uint8_t target_system, uint8_t cmd, const char *mission_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LEAF_CONTROL_CMD_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_leaf_control_cmd_send(chan, leaf_control_cmd->target_system, leaf_control_cmd->cmd, leaf_control_cmd->mission_id);
#else
 ...
 */
static inline void mavlink_msg_leaf_control_cmd_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t cmd, const char *mission_id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS

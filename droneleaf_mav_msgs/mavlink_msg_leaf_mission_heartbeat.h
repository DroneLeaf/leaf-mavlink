...
#define MAVLINK_MSG_ID_LEAF_MISSION_HEARTBEAT_LEN 198
#define MAVLINK_MSG_ID_LEAF_MISSION_HEARTBEAT_MIN_LEN 198
#define MAVLINK_MSG_ID_77044_LEN 198
#define MAVLINK_MSG_ID_77044_MIN_LEN 198

#define MAVLINK_MSG_ID_LEAF_MISSION_HEARTBEAT_CRC 198
#define MAVLINK_MSG_ID_77044_CRC 198

#define MAVLINK_MSG_LEAF_MISSION_HEARTBEAT_FIELD_MISSION_ID_LEN 64
#define MAVLINK_MSG_LEAF_MISSION_HEARTBEAT_FIELD_MISSION_NAME_LEN 64
#define MAVLINK_MSG_LEAF_MISSION_HEARTBEAT_FIELD_STEP_NAME_LEN 64
...
#define MAVLINK_MESSAGE_INFO_LEAF_MISSION_HEARTBEAT { \
    ...
    9, \
    {  { "LeafFC_mission_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_leaf_mission_heartbeat_t, LeafFC_mission_status) }, \
         ...
         { "SDK_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 68, offsetof(mavlink_leaf_mission_heartbeat_t, SDK_status) }, \
         { "mission_name", NULL, MAVLINK_TYPE_CHAR, 64, 69, offsetof(mavlink_leaf_mission_heartbeat_t, mission_name) }, \
         { "step_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 133, offsetof(mavlink_leaf_mission_heartbeat_t, step_type) }, \
         { "step_name", NULL, MAVLINK_TYPE_CHAR, 64, 134, offsetof(mavlink_leaf_mission_heartbeat_t, step_name) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_LEAF_MISSION_HEARTBEAT { \
...
{
    return mavlink_msg_leaf_mission_heartbeat_pack(system_id, component_id, msg, leaf_mission_heartbeat->LeafFC_mission_status, leaf_mission_heartbeat->joystick_mode, leaf_mission_heartbeat->mission_id, leaf_mission_heartbeat->queue_count, leaf_mission_heartbeat->predefined_actions_status, leaf_mission_heartbeat->SDK_status, leaf_mission_heartbeat->mission_name, leaf_mission_heartbeat->step_type, leaf_mission_heartbeat->step_name);
}
...
{
    return mavlink_msg_leaf_mission_heartbeat_pack_chan(system_id, component_id, chan, msg, leaf_mission_heartbeat->LeafFC_mission_status, leaf_mission_heartbeat->joystick_mode, leaf_mission_heartbeat->mission_id, leaf_mission_heartbeat->queue_count, leaf_mission_heartbeat->predefined_actions_status, leaf_mission_heartbeat->SDK_status, leaf_mission_heartbeat->mission_name, leaf_mission_heartbeat->step_type, leaf_mission_heartbeat->step_name);
}
...
{
    return mavlink_msg_leaf_mission_heartbeat_pack_status(system_id, component_id, _status, msg,  leaf_mission_heartbeat->LeafFC_mission_status, leaf_mission_heartbeat->joystick_mode, leaf_mission_heartbeat->mission_id, leaf_mission_heartbeat->queue_count, leaf_mission_heartbeat->predefined_actions_status, leaf_mission_heartbeat->SDK_status, leaf_mission_heartbeat->mission_name, leaf_mission_heartbeat->step_type, leaf_mission_heartbeat->step_name);
}
...
static inline void mavlink_msg_leaf_mission_heartbeat_send(mavlink_channel_t chan, uint8_t LeafFC_mission_status, uint8_t joystick_mode, const char *mission_id, uint8_t queue_count, uint8_t predefined_actions_status, uint8_t SDK_status, const char *mission_name, uint8_t step_type, const char *step_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LEAF_MISSION_HEARTBEAT_LEN];
    _mav_put_uint8_t(buf, 0, LeafFC_mission_status);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_leaf_mission_heartbeat_send(chan, leaf_mission_heartbeat->LeafFC_mission_status, leaf_mission_heartbeat->joystick_mode, leaf_mission_heartbeat->mission_id, leaf_mission_heartbeat->queue_count, leaf_mission_heartbeat->predefined_actions_status, leaf_mission_heartbeat->SDK_status, leaf_mission_heartbeat->mission_name, leaf_mission_heartbeat->step_type, leaf_mission_heartbeat->step_name);
#else
 ...
 */
static inline void mavlink_msg_leaf_mission_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t LeafFC_mission_status, uint8_t joystick_mode, const char *mission_id, uint8_t queue_count, uint8_t predefined_actions_status, uint8_t SDK_status, const char *mission_name, uint8_t step_type, const char *step_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field LeafFC_mission_status from leaf_mission_heartbeat message
 *
 * @return  LeafFC mission status
 */
static inline uint8_t mavlink_msg_leaf_mission_heartbeat_get_LeafFC_mission_status(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field SDK_status from leaf_mission_heartbeat message
 *
 * @return  SDK mission status
 */
static inline uint8_t mavlink_msg_leaf_mission_heartbeat_get_SDK_status(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  68);
}

/**
 * @brief Get field mission_name from leaf_mission_heartbeat message
 *
 * @return  The name of the mission
 */
static inline uint16_t mavlink_msg_leaf_mission_heartbeat_get_mission_name(const mavlink_message_t* msg, char *mission_name)
{
    return _MAV_RETURN_char_array(msg, mission_name, 64,  69);
}

/**
 * @brief Get field step_type from leaf_mission_heartbeat message
 *
 * @return  The number of missions in the queue
 */
static inline uint8_t mavlink_msg_leaf_mission_heartbeat_get_step_type(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  133);
}

/**
 * @brief Get field step_name from leaf_mission_heartbeat message
 *
 * @return  The name of the current step
 */
static inline uint16_t mavlink_msg_leaf_mission_heartbeat_get_step_name(const mavlink_message_t* msg, char *step_name)
{
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    leaf_mission_heartbeat->LeafFC_mission_status = mavlink_msg_leaf_mission_heartbeat_get_LeafFC_mission_status(msg);
    ...
    leaf_mission_heartbeat->SDK_status = mavlink_msg_leaf_mission_heartbeat_get_SDK_status(msg);
    mavlink_msg_leaf_mission_heartbeat_get_mission_name(msg, leaf_mission_heartbeat->mission_name);
    leaf_mission_heartbeat->step_type = mavlink_msg_leaf_mission_heartbeat_get_step_type(msg);
    mavlink_msg_leaf_mission_heartbeat_get_step_name(msg, leaf_mission_heartbeat->step_name);
#else

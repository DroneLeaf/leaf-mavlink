...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH -3326863855420201251
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_GPS_MANAGER_STATUS
#define HAVE_ENUM_LEAF_GPS_MANAGER_STATUS
typedef enum LEAF_GPS_MANAGER_STATUS
{
   LEAF_GPS_MANAGER_STATUS_NO_GPS_DATA=0, /* No GPS data received from PX4 yet | */
   LEAF_GPS_MANAGER_STATUS_COMPUTING_ORIGIN_FROM_NED=1, /* GPS fix obtained — computing origin from NED + GPS position | */
   LEAF_GPS_MANAGER_STATUS_ORIGIN_SET=2, /* GPS origin is set and valid | */
...
#include "./mavlink_msg_leaf_gps_origin_status.h"

#pragma once
// MESSAGE LEAF_QGC_CONTROL_CMD PACKING

#define MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD 77036
...
#define MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_LEN 3
#define MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_MIN_LEN 3
#define MAVLINK_MSG_ID_77036_LEN 3
#define MAVLINK_MSG_ID_77036_MIN_LEN 3

#define MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_CRC 130
#define MAVLINK_MSG_ID_77036_CRC 130
...
/**
 * @brief Pack a leaf_qgc_control_cmd message
...
static inline uint16_t mavlink_msg_leaf_qgc_control_cmd_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t cmd, uint8_t action)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD;
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_MIN_LEN, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_LEN, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_CRC);
}
                               ...
                               uint8_t target_system, uint8_t cmd, uint8_t action)
{
    ...
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_MIN_LEN, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_LEN, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_CRC);
#else
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_MIN_LEN, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_LEN);
#endif
}

/**
 * @brief Pack a leaf_qgc_control_cmd message on a channel
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
                                   ...
                                   uint8_t target_system,uint8_t cmd,uint8_t action)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_MIN_LEN, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_LEN, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_CRC);
}

/**
 * @brief Encode a leaf_qgc_control_cmd struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param leaf_qgc_control_cmd C-struct to read the message contents from
 */
...
{
    return mavlink_msg_leaf_qgc_control_cmd_pack(system_id, component_id, msg, leaf_qgc_control_cmd->target_system, leaf_qgc_control_cmd->cmd, leaf_qgc_control_cmd->action);
}

/**
 * @brief Encode a leaf_qgc_control_cmd struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
...
{
    return mavlink_msg_leaf_qgc_control_cmd_pack_chan(system_id, component_id, chan, msg, leaf_qgc_control_cmd->target_system, leaf_qgc_control_cmd->cmd, leaf_qgc_control_cmd->action);
}

/**
 * @brief Encode a leaf_qgc_control_cmd struct with provided status structure
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param status MAVLink status structure
...
{
    return mavlink_msg_leaf_qgc_control_cmd_pack_status(system_id, component_id, _status, msg,  leaf_qgc_control_cmd->target_system, leaf_qgc_control_cmd->cmd, leaf_qgc_control_cmd->action);
}

/**
 * @brief Send a leaf_qgc_control_cmd message
...
static inline void mavlink_msg_leaf_qgc_control_cmd_send(mavlink_channel_t chan, uint8_t target_system, uint8_t cmd, uint8_t action)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_leaf_qgc_control_cmd_send(chan, leaf_qgc_control_cmd->target_system, leaf_qgc_control_cmd->cmd, leaf_qgc_control_cmd->action);
#else
...
#if MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
 ...
 */
static inline void mavlink_msg_leaf_qgc_control_cmd_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t cmd, uint8_t action)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
// MESSAGE LEAF_QGC_CONTROL_CMD UNPACKING


/**
 * @brief Get field target_system from leaf_qgc_control_cmd message
 *
 * @return  The system needs to execute a control command
 */
static inline uint8_t mavlink_msg_leaf_qgc_control_cmd_get_target_system(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  0);
}

/**
 * @brief Get field cmd from leaf_qgc_control_cmd message
 *
 * @return  The control command to execute
 */
static inline uint8_t mavlink_msg_leaf_qgc_control_cmd_get_cmd(const mavlink_message_t* msg)
{
...
/**
 * @brief Decode a leaf_qgc_control_cmd message into a struct
 *
 * @param msg The message to decode
 * @param leaf_qgc_control_cmd C-struct to decode the message contents into
 */
static inline void mavlink_msg_leaf_qgc_control_cmd_decode(const mavlink_message_t* msg, mavlink_leaf_qgc_control_cmd_t* leaf_qgc_control_cmd)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    ...
    leaf_qgc_control_cmd->action = mavlink_msg_leaf_qgc_control_cmd_get_action(msg);
        ...
        memset(leaf_qgc_control_cmd, 0, MAVLINK_MSG_ID_LEAF_QGC_CONTROL_CMD_LEN);
    memcpy(leaf_qgc_control_cmd, _MAV_PAYLOAD(msg), len);
#endif
}

...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH -7024866019179544500
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_RUNNER_STATE
#define HAVE_ENUM_LEAF_MISSION_RUNNER_STATE
typedef enum LEAF_MISSION_RUNNER_STATE
{
   LEAF_MISSION_RUNNER_STATE_NOTREADY=0, /* No mission is active | */
   LEAF_MISSION_RUNNER_STATE_IDLE=1, /* A mission is loaded but not executing | */
   LEAF_MISSION_RUNNER_STATE_EXECUTING=2, /* A mission is currently executing | */
   LEAF_MISSION_RUNNER_STATE_PAUSED=3, /* A mission is loaded and paused | */
   LEAF_MISSION_RUNNER_STATE_ENUM_END=4, /*  | */
} LEAF_MISSION_RUNNER_STATE;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_PAUSE_STAGE
#define HAVE_ENUM_LEAF_MISSION_PAUSE_STAGE
typedef enum LEAF_MISSION_PAUSE_STAGE
{
   LEAF_MISSION_PAUSE_STAGE_NONE=0, /* Not paused and no pause scheduled | */
   LEAF_MISSION_PAUSE_STAGE_SCHEDULED=1, /* A pause is scheduled but not yet active | */
   LEAF_MISSION_PAUSE_STAGE_BETWEEN_STEPS=2, /* Paused between two steps | */
   LEAF_MISSION_PAUSE_STAGE_MID_STEP=3, /* Paused in the middle of an executing step | */
   LEAF_MISSION_PAUSE_STAGE_ENUM_END=4, /*  | */
} LEAF_MISSION_PAUSE_STAGE;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_QUEUE_STATE
#define HAVE_ENUM_LEAF_QUEUE_STATE
typedef enum LEAF_QUEUE_STATE
{
   LEAF_QUEUE_STATE_EMPTY=0, /* No missions in the queue | */
   LEAF_QUEUE_STATE_PARTIAL=1, /* Queue has missions but is not full | */
   LEAF_QUEUE_STATE_FULL=2, /* Queue is at maximum capacity | */
   LEAF_QUEUE_STATE_ENUM_END=3, /*  | */
} LEAF_QUEUE_STATE;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_COMPLETION_STATE
#define HAVE_ENUM_LEAF_MISSION_COMPLETION_STATE
typedef enum LEAF_MISSION_COMPLETION_STATE
{
   LEAF_MISSION_COMPLETION_STATE_NONE=0, /* No previous mission, or mission has not completed yet | */
   LEAF_MISSION_COMPLETION_STATE_SUCCESS=1, /* Last mission completed successfully | */
   LEAF_MISSION_COMPLETION_STATE_ABORTED=2, /* Last mission was aborted | */
   LEAF_MISSION_COMPLETION_STATE_FAILED=3, /* Last mission failed | */
   LEAF_MISSION_COMPLETION_STATE_ENUM_END=4, /*  | */
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_MODE
#define HAVE_ENUM_LEAF_MISSION_MODE
typedef enum LEAF_MISSION_MODE
{
   LEAF_MISSION_MODE_PREDEFINED=0, /* Executing a predefined mission | */
   LEAF_MISSION_MODE_INTERACTIVE=1, /* Executing an interactive mission created at runtime | */
   LEAF_MISSION_MODE_ENUM_END=2, /*  | */
} LEAF_MISSION_MODE;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_PREDEFINED_MISSION_TYPE
#define HAVE_ENUM_LEAF_PREDEFINED_MISSION_TYPE
typedef enum LEAF_PREDEFINED_MISSION_TYPE
{
   LEAF_PREDEFINED_MISSION_TYPE_LEAF_SCRIPT=0, /* Mission loaded from a LeafScript file | */
   LEAF_PREDEFINED_MISSION_TYPE_QGC=1, /* Mission loaded from a QGroundControl plan | */
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_GPS_MANAGER_STATE
#define HAVE_ENUM_LEAF_GPS_MANAGER_STATE
typedef enum LEAF_GPS_MANAGER_STATE
{
   LEAF_GPS_MANAGER_STATE_NO_GPS_DATA=0, /* No GPS data received from PX4 yet | */
   LEAF_GPS_MANAGER_STATE_COMPUTING_ORIGIN_FROM_NED=1, /* GPS fix obtained — computing origin from NED + GPS position | */
   LEAF_GPS_MANAGER_STATE_ORIGIN_SET=2, /* GPS origin is set and valid | */
   LEAF_GPS_MANAGER_STATE_ENUM_END=3, /*  | */
} LEAF_GPS_MANAGER_STATE;
#endif
...
#include "./mavlink_msg_leaf_petal_mission_manager_heartbeat.h"
#include "./mavlink_msg_leaf_gps_origin_status.h"
#include "./mavlink_msg_leaf_mission_info.h"
#include "./mavlink_msg_leaf_mission_execution_step_info.h"
#include "./mavlink_msg_leaf_fc_mission_manager_heartbeat.h"

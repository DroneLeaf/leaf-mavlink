...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH -5553005961385229187
...
/** @brief  */
#ifndef HAVE_ENUM_JOYSTICK_MODE
#define HAVE_ENUM_JOYSTICK_MODE
typedef enum JOYSTICK_MODE
{
   JOYSTICK_MODE_DISABLED=0, /* Joystick is disabled | */
   JOYSTICK_MODE_ENABLED_ALWAYS=1, /* Joystick is always enabled | */
   JOYSTICK_MODE_ENABLED_ON_PAUSE=2, /* Joystick is enabled only on pause | */

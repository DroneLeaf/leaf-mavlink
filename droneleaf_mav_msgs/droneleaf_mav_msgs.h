...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH -5699057010307927848
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_TYPE
#define HAVE_ENUM_LEAF_MISSION_TYPE
typedef enum LEAF_MISSION_TYPE
{
   LEAF_MISSION_TYPE_LEAF_SCRIPT=0, /* Mission loaded from a LeafScript file | */
   LEAF_MISSION_TYPE_QGC=1, /* Mission loaded from a QGroundControl plan | */
   LEAF_MISSION_TYPE_INTERACTIVE_MISSION=2, /* Mission created interactively at runtime | */

/** @file
 *  @brief MAVLink comm protocol generated from droneleaf_mav_msgs.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_DRONELEAF_MAV_MSGS_H
#define MAVLINK_DRONELEAF_MAV_MSGS_H
...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH 3092567170717241041
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_ARM_STAGE
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_LANDING_STATUS
#define HAVE_ENUM_LEAF_LANDING_STATUS
typedef enum LEAF_LANDING_STATUS
{
   LEAF_LANDING_NOT_LANDING=0, /* Landing not started yet | */
   LEAF_LANDING_LANDING=1, /* Vehicle is landing | */
   LEAF_LANDING_LANDING_COMPLETED=2, /* Vehicle has completed landing | */
   LEAF_LANDING_STATUS_ENUM_END=3, /*  | */
} LEAF_LANDING_STATUS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_LEARNING_STATUS
#define HAVE_ENUM_LEAF_LEARNING_STATUS
typedef enum LEAF_LEARNING_STATUS
{
   NOT_LEARNING=0, /* Learning not started | */
   LEARNING_IN_PROGRESS=1, /* Vehicle is learning | */
   LEARNING_COMPLETED=2, /* Vehicle has completed learning | */
   LEAF_LEARNING_STATUS_ENUM_END=3, /*  | */
} LEAF_LEARNING_STATUS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_CONTROL_COMMAND
#define HAVE_ENUM_LEAF_MISSION_CONTROL_COMMAND
typedef enum LEAF_MISSION_CONTROL_COMMAND
{
   LEAF_MISSION_CONTROL_PAUSE=0, /* Pause the exection of the current mission | */
   LEAF_MISSION_CONTROL_RESUME=1, /* Resume the exection of the current mission | */
   LEAF_MISSION_CONTROL_ABORT=2, /* Abort the exection of the current mission | */
   LEAF_MISSION_CONTROL_LAND_IN_PLACE=3, /* Land in place | */
   LEAF_MISSION_CONTROL_RETURN_TO_LAUNCH=4, /* Return to launch | */
   LEAF_MISSION_CONTROL_READY=5, /* Set the vehicle to mission ready state | */
   LEAF_MISSION_CONTROL_START=6, /* Start the mission | */
   LEAF_MISSION_CONTROL_COMMAND_ENUM_END=7, /*  | */
} LEAF_MISSION_CONTROL_COMMAND;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_STATE
#define HAVE_ENUM_LEAF_MISSION_STATE
typedef enum LEAF_MISSION_STATE
{
   LEAF_MISSION_STATE_IDLE=0, /* Queue is empty, no mission loaded | */
   LEAF_MISSION_STATE_READY=1, /* Current mission is ready to execute | */
   LEAF_MISSION_STATE_RUNNING=2, /* Current mission is running | */
   LEAF_MISSION_STATE_SCHEDULED_PAUSE=3, /* Current mission is running but has a scheduled pause | */
   LEAF_MISSION_STATE_PAUSED_MID_STEP=4, /* Current mission is paused mid-step | */
   LEAF_MISSION_STATE_PAUSED_BETWEEN_STEPS=5, /* Current mission is paused between steps | */
   LEAF_MISSION_STATE_COMPLETED=6, /* Current mission completed successfully | */
   LEAF_MISSION_STATE_FAILED=7, /* Current mission failed | */
   LEAF_MISSION_STATE_CANCELLED=8, /* Current mission was cancelled | */
...
{
   LEAF_SDK_STATUS_HEALTHY=0, /* SDK is operating normally | */
   LEAF_SDK_STATUS_UNHEALTHY=1, /* SDK is abnormally unhealthy | */
   LEAF_SDK_STATUS_JOYSTICK_MISMATCH=2, /* FC reported joystick mode does not match the requested mode | */
   LEAF_SDK_STATUS_JOYSTICK_TIMEOUT=3, /* FC did not confirm joystick mode change within timeout | */
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_STATUS
#define HAVE_ENUM_LEAF_STATUS
typedef enum LEAF_STATUS
{
   LEAF_STATUS_READY_TO_LEARN=0, /* Leaf is ready to learn | */
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_PREDEFINED_ACTIONS_STATUS
#define HAVE_ENUM_LEAF_PREDEFINED_ACTIONS_STATUS
typedef enum LEAF_PREDEFINED_ACTIONS_STATUS
{
   NOT_STARTED=0, /* Predefined actions have not started | */
   TAKING_OFF=1, /* Predefined actions are taking off | */
   LANDING=2, /* Predefined actions are landing | */
   RETURNING_TO_LAUNCH=3, /* Predefined actions are returning to launch | */
   GOTO_XYZ=4, /* Going to single location | */
   LEAF_PREDEFINED_ACTIONS_STATUS_ENUM_END=5, /*  | */
} LEAF_PREDEFINED_ACTIONS_STATUS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_MISSION_STEP_TYPE
#define HAVE_ENUM_LEAF_MISSION_STEP_TYPE
typedef enum LEAF_MISSION_STEP_TYPE
{
   IDLE=0, /* Idle | */
   GOTO_GPS_WAYPOINT=1, /* Going to GPS waypoint | */
   GOTO_LOCAL_POSITION=2, /* Goto local position | */
   GOTO_RELATIVE=3, /* Goto relative position | */
   YAW_ABSOLUTE=4, /* Yaw absolute | */
   YAW_RELATIVE=5, /* Yaw relative | */
   TAKEOFF=6, /* Takeoff | */
   WAIT=7, /* Wait | */
   LAND=8, /* Land | */
   RETURN_TO_LAUNCH=9, /* Return to launch | */
   LEAF_MISSION_STEP_TYPE_ENUM_END=10, /*  | */
} LEAF_MISSION_STEP_TYPE;
#endif

/** @brief  */
#ifndef HAVE_ENUM_LEAF_PRE_IDLE_CHECK_STATUS
...
/** @brief  */
#ifndef HAVE_ENUM_LEAF_TAKEOFF_STATUS
#define HAVE_ENUM_LEAF_TAKEOFF_STATUS
typedef enum LEAF_TAKEOFF_STATUS
{
   LEAF_TAKEOFF_ON_GROUND=0, /* Vehicle is on ground | */
   LEAF_TAKEOFF_TAKING_OFF=1, /* Vehicle is taking off | */
   LEAF_TAKEOFF_COMPLETED=2, /* Vehicle has completed taking off | */
   LEAF_TAKEOFF_STATUS_ENUM_END=3, /*  | */
} LEAF_TAKEOFF_STATUS;
#endif

/** @brief  */
#ifndef HAVE_ENUM_JoystickMode
#define HAVE_ENUM_JoystickMode
typedef enum JoystickMode
{
   DISABLED=0, /* Joystick is disabled | */
   ENABLED_ALWAYS=1, /* Joystick is always enabled | */
   ENABLED_ON_PAUSE=2, /* Joystick is enabled only on pause | */
...
#endif // __cplusplus
#endif // MAVLINK_DRONELEAF_MAV_MSGS_H

...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH -9178836077755829100
...
{
   LEAF_MISSION_MANAGER_STATE_IDLE=0, /* No mission is active | */
   LEAF_MISSION_MANAGER_STATE_EXECUTING=1, /* A mission is currently executing | */
   LEAF_MISSION_MANAGER_STATE_PAUSED=2, /* A mission is loaded and paused | */
   LEAF_MISSION_MANAGER_STATE_ENUM_END=3, /*  | */

...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH 1527264336941529942
...
typedef enum LEAF_CONTROL_COMMAND_ACTION
{
   ...
   LEAF_CONTROL_COMMAND_ACTION_STOP_AND_RTL=3, /* Stop the current trajectory and return to launch | */
   LEAF_CONTROL_COMMAND_ACTION_LIP=4, /* Land in place | */
   LEAF_CONTROL_COMMAND_ACTION_STOP_AND_LIP=5, /* Stop the current trajectory and land in place | */

...
#define MAVLINK_DRONELEAF_MAV_MSGS_XML_HASH 5342118254389148285
...
typedef enum LEAF_MISSION_STATUS
{
   ...
   LEAF_MISSION_STATUS_EXECUTING=1, /* Leaf mission manager is executing a mission | */
   LEAF_MISSION_STATUS_PAUSED=2, /* Leaf mission manager has paused the mission | */
   LEAF_MISSION_STATUS_COMPLETED=3, /* Leaf mission manager has completed the mission | */
   LEAF_MISSION_STATUS_CANCELED=4, /* Leaf mission manager has canceled the mission | */
   LEAF_MISSION_STATUS_ABORTED=5, /* Leaf mission manager has aborted the mission | */
